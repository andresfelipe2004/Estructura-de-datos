...
import co.edu.unipiloto.estdatos.tallergen.mundo.Camisa.marca;
...
import co.edu.unipiloto.estdatos.tallergen.mundo.Computador.sistema;
...
public class Main {
    ...
    public void agregarCamisa() throws Exception {
       ...
       int indice = Integer.parseInt(br.readLine());
        ...
        Producto camisa = new Camisa(Marcaa, talla, precio);
    ...
    public void agregarComputador() throws Exception {
        System.out.println("* * * * * * * * * * * * * * * * ");
        System.out.println("<< Agregar comptador >>\n");
        System.out.println("¿tipo? ");
        
        sistema [] sist = sistema.values();

        for (int i = 0; i < sist.length; i++) {
            System.out.println("[" + (i + 1) + "] " + sist[i]);
        }

        int indice = Integer.parseInt(br.readLine());
        sistema sistem = sist[indice - 1];
        ...
        Producto computador = new Computador(sistem, gama, precio);
        int respuesta = casilleros.almacenar(computador);

        if (respuesta != -1) {
            System.out.println("el computador ha sido almacenada en el casillero " + respuesta);
        } else {
            System.out.println("No hay casilleros disponibles para almacenar la compra");
        }
        System.out.println("::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::");
